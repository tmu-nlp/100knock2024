...
def visualize_dependency_tree(chunks):
    ...
    for i, chunk in enumerate(chunks):
        ...
        if chunk.dst != -1:
            ...
            dot.edge(str(i), str(chunk.dst), label="")
    return dot
...
# 冒頭の文の係り受け木を可視化
dot = visualize_dependency_tree(sentences_with_chunks[0])
dot.render('dependency_tree')

print("解析が完了しました。係り受け木は 'dependency_tree.png' として保存されました。")
