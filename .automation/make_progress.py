...
def plot_progress(users: np.array, scores: np.array):
    ...
    date_list = list()
    date_list.append(datetime.date(2024, 4, 22))
    ...
    date_list.append(datetime.date(2024, 6, 24))
    date_list.append(datetime.date(2024, 7, 8))
    date_list.append(datetime.date(2024, 7, 29))
    date_list.append(datetime.date(2024, 8, 30))
    # print(date_list)
