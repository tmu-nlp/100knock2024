...
def train_model(model, criterion, optimizer, train_loader, valid_loader, num_epochs, checkpoint_dir):
    train_losses = []
    train_accs = []
    valid_losses = []
    valid_accs = []
...
def main():
    ...
    train_losses, train_accs, valid_losses, valid_accs = train_model(
        model, criterion, optimizer, dataloader_train, dataloader_valid, num_epochs, checkpoint_dir)
